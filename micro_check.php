...
<link href="micro_check.css" type="text/css" rel="stylesheet" />
</HEAD>
<BODY>
...
$query = "SELECT distinct *
          ...
          WHERE B.book_name='$key' AND A.publisher_name = B.publisher_name   AND C.book_name = B.book_name AND D.book_name = B.book_name";
